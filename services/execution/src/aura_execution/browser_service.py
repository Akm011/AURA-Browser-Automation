...
class BrowserExecutionService:
    """Orchestrates planning and browser execution for API and dashboard clients."""
    ...
    def list_skills(self) -> list[str]:
        return ActionExecutor().registry.list_names() + [ActionExecutor.NAVIGATE_SKILL, "Wait"]
    ...
    def _runtime_settings(self, headed: bool | None) -> AuraSettings:
    ...
    async def _process_task(self, task_id: str) -> None:
        ...
        settings = self._runtime_settings(task.headed)
        configure_logging(settings)
